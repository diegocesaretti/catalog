...
public final class GamePreferences {
    private static final String FILE = "snap_penalty_safe_preferences_v3";
    private static final String KEY_AIM_SENSITIVITY = "aim_sensitivity";
    private static final String KEY_SNAP_SENSITIVITY = "snap_sensitivity_v2";
    ...
    public static int getSnapSensitivity(Context context) {
        return prefs(context).getInt(KEY_SNAP_SENSITIVITY, 14);
    }
